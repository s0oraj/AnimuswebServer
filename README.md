# animus-api-springboot
animus api by using springboot


## Live App Link
https://animus-api-springboot-production.up.railway.app/api
...
```javascript
try {
    const res = await fetch(`https://animus-api-springboot-production.up.railway.app/signup`, {
      method: "POST",
      headers: {
...
```javascript
  try {
    const res = await fetch(`https://animus-api-springboot-production.up.railway.app/signin`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
## Base URL : https://animus-api-springboot-production.up.railway.app
